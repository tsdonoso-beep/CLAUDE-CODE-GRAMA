...
export type TipoContenido = 'VIDEO' | 'PDF' | 'PRESENTACION' | 'INTERACTIVO' | 'QUIZ' | 'EN_VIVO' | 'DESCARGABLE' | 'ACTIVIDAD_PRACTICA'
  ...
  // ── M0 — Inicio y Diagnóstico (14h) ─────────────────────────────────────
  {
    ...
    sesiones: [
      ...
      { id: 'M0-S02-A', nombre: 'Introducción a las Herramientas Digitales',
        ...
        duracionHoras: 0.5, modalidad: 'asincrono', formato: 'Presentación + Video + Interactivo',
        contenidos: [
          { id: 'm0-s02-c1', tipo: 'PRESENTACION', titulo: 'Slides: Herramientas digitales para docentes', duracionMin: 10 },
          { id: 'm0-s02-c2', tipo: 'VIDEO',         titulo: 'Video: Herramientas digitales en el aula EPT', duracionMin: 10 },
          { id: 'm0-s02-c3', tipo: 'INTERACTIVO',   titulo: '¿Qué herramienta para cada tarea? — Clasifica las herramientas por uso', duracionMin: 10 }] },
      { id: 'M0-S03-A', nombre: 'Google Workspace (Calendar, Docs, Sheets, Slides, Tasks)',
        ...
        duracionHoras: 2, modalidad: 'asincrono', formato: 'Presentación + Videos + Interactivo',
        contenidos: [
          { id: 'm0-s03-c1', tipo: 'PRESENTACION', titulo: 'Slides: Google Workspace para docentes', duracionMin: 20 },
          { id: 'm0-s03-c2', tipo: 'VIDEO',         titulo: 'Video: Calendar, Docs y Sheets en el aula', duracionMin: 30 },
          { id: 'm0-s03-c3', tipo: 'VIDEO',         titulo: 'Video: Slides y Tasks para planificación',  duracionMin: 25 },
          { id: 'm0-s03-c4', tipo: 'INTERACTIVO',   titulo: 'Práctica: Crea tu plantilla de planificación semanal en Google Docs', duracionMin: 25 },
          { id: 'm0-s03-c5', tipo: 'QUIZ',          titulo: 'Quiz: Google Workspace', preguntas: 8, duracionMin: 20 }] },
      { id: 'M0-S04-A', nombre: 'IA para el Aprendizaje (Diseño de Prompt, GPT, Claude, Gemini, NotebookLm)',
        ...
        duracionHoras: 1.5, modalidad: 'asincrono', formato: 'Presentación + Video + Interactivo',
        contenidos: [
          { id: 'm0-s04-c1', tipo: 'PRESENTACION', titulo: 'Slides: IA generativa para docentes', duracionMin: 15 },
          { id: 'm0-s04-c2', tipo: 'VIDEO',         titulo: 'Video: Diseño de prompts — GPT, Claude y Gemini', duracionMin: 35 },
          { id: 'm0-s04-c3', tipo: 'INTERACTIVO',   titulo: 'Laboratorio de prompts: Construye instrucciones para IA según tu taller', duracionMin: 25 },
          { id: 'm0-s04-c4', tipo: 'QUIZ',          titulo: 'Quiz: IA para el Aprendizaje', preguntas: 6, duracionMin: 15 }] },
      { id: 'M0-S05-A', nombre: 'IA para el Aprendizaje (Gamma, Teachy, Polypad, Meshy)',
        ...
        duracionHoras: 1.5, modalidad: 'asincrono', formato: 'Presentación + Videos + Interactivo',
        contenidos: [
          { id: 'm0-s05-c1', tipo: 'PRESENTACION', titulo: 'Slides: IA creativa para la enseñanza', duracionMin: 15 },
          { id: 'm0-s05-c2', tipo: 'VIDEO',         titulo: 'Video: Gamma y Teachy para crear materiales educativos', duracionMin: 25 },
          { id: 'm0-s05-c3', tipo: 'VIDEO',         titulo: 'Video: Polypad y Meshy en el taller técnico', duracionMin: 25 },
          { id: 'm0-s05-c4', tipo: 'INTERACTIVO',   titulo: 'Reto creativo: Diseña una lámina de tu taller con Gamma AI', duracionMin: 15 },
          { id: 'm0-s05-c5', tipo: 'QUIZ',          titulo: 'Quiz: Herramientas IA creativas', preguntas: 6, duracionMin: 10 }] },
      { id: 'M0-S06-A', nombre: 'Herramienta de ideación (Miró, Mural, Figma)',
        descripcion: 'Herramientas digitales para el trabajo en equipo.',
        duracionHoras: 1.5, modalidad: 'asincrono', formato: 'Presentación + Videos + Interactivo',
        contenidos: [
          { id: 'm0-s06-c1', tipo: 'PRESENTACION', titulo: 'Slides: Herramientas de ideación colaborativa', duracionMin: 15 },
          { id: 'm0-s06-c2', tipo: 'VIDEO',         titulo: 'Video: Miró y Mural para trabajo en equipo', duracionMin: 25 },
          { id: 'm0-s06-c3', tipo: 'VIDEO',         titulo: 'Video: Figma para diseño colaborativo', duracionMin: 25 },
          { id: 'm0-s06-c4', tipo: 'INTERACTIVO',   titulo: 'Actividad: Construye el mapa de espacios de tu taller en Miró', duracionMin: 15 },
          { id: 'm0-s06-c5', tipo: 'QUIZ',          titulo: 'Quiz: Herramientas de ideación', preguntas: 6, duracionMin: 10 }] },
  ...
  // ── M1 — Reconocimiento del Taller (22h) ────────────────────────────────
  {
    ...
    sesiones: [
      ...
      { id: 'M1-S11-A', nombre: 'Exploro el metrado general de equipos',
        ...
        duracionHoras: 4, modalidad: 'asincrono', formato: 'Video + Interactivo + Quiz + DES',
        contenidos: [
          { id: 'm1-s11-c1', tipo: 'VIDEO',        titulo: 'Video: Metrado general de equipos del taller', duracionMin: 120 },
          { id: 'm1-s11-c2', tipo: 'INTERACTIVO',  titulo: 'Explorador de equipos: Arrastra cada equipo a su zona y tipo correspondiente', duracionMin: 60 },
          { id: 'm1-s11-c3', tipo: 'QUIZ',         titulo: 'Quiz: Metrado de equipos', preguntas: 10, duracionMin: 30 },
          { id: 'm1-s11-c4', tipo: 'DESCARGABLE',  titulo: 'Ficha de metrado de equipos', duracionMin: 30, descargableId: 'desc-m1-meca-metrado' }] },
      { id: 'M1-S12-A', nombre: 'Instalación (Teórico + softwares)',
        ...
        contenidos: [
          ...
          { id: 'm1-s12-c3', tipo: 'DESCARGABLE', titulo: 'Guía de instalación de equipos',               duracionMin: 45, descargableId: 'desc-m1-meca-instalacion' }] },
      { id: 'M1-S13-A', nombre: 'Medidas de seguridad',
        descripcion: 'EPP y seguridad en el taller.',
        duracionHoras: 1, modalidad: 'asincrono', formato: 'Video + Interactivo + Quiz + DES',
        contenidos: [
          { id: 'm1-s13-c1', tipo: 'VIDEO',        titulo: 'Video: EPP y seguridad en el taller', duracionMin: 15 },
          { id: 'm1-s13-c2', tipo: 'INTERACTIVO',  titulo: 'Simulador: ¿Qué EPP necesito para cada actividad del taller?', duracionMin: 15 },
          { id: 'm1-s13-c3', tipo: 'QUIZ',         titulo: 'Quiz: Medidas de seguridad', preguntas: 8, bloqueaSiguiente: true, puntajeMinimo: 80, duracionMin: 20 },
          { id: 'm1-s13-c4', tipo: 'DESCARGABLE',  titulo: 'Protocolo de seguridad del taller', duracionMin: 10, descargableId: 'desc-m1-meca-seguridad' }] },
      { id: 'M1-S14-A', nombre: 'Garantía',
        ...
        contenidos: [
          ...
          { id: 'm1-s14-c3', tipo: 'DESCARGABLE', titulo: 'Guía de garantías y cuidados',                    duracionMin: 20, descargableId: 'desc-m1-meca-garantias' }] },
  ...
  // ── M2 — Zona de Investigación (20h) ────────────────────────────────────
  {
    ...
    sesiones: [
      ...
      { id: 'M2-S19-A', nombre: 'Consumibles',
        ...
        duracionHoras: 1.5, modalidad: 'asincrono', formato: 'Presentación + Video + Interactivo + Actividad',
        contenidos: [
          { id: 'm2-s19-c1', tipo: 'PRESENTACION',       titulo: 'Slides: Consumibles de la Zona de Investigación', duracionMin: 15 },
          { id: 'm2-s19-c2', tipo: 'VIDEO',              titulo: 'Video: Tipos y uso de consumibles por equipo', duracionMin: 20 },
          { id: 'm2-s19-c3', tipo: 'INTERACTIVO',        titulo: 'Seleccionador: ¿Qué consumible corresponde a cada equipo de investigación?', duracionMin: 20 },
          { id: 'm2-s19-c4', tipo: 'ACTIVIDAD_PRACTICA', titulo: 'Actividad: Inventario de consumibles del taller', duracionMin: 35 }] },
      ...
      { id: 'M2-S22-A', nombre: 'Mantenimiento preventivo',
        duracionHoras: 2, modalidad: 'asincrono', formato: 'Presentación + Manuales + Interactivo + Actividad',
        contenidos: [
          { id: 'm2-s22-c1', tipo: 'PRESENTACION',       titulo: 'Slides: Mantenimiento preventivo — Zona de Investigación', duracionMin: 20 },
          { id: 'm2-s22-c2', tipo: 'PDF',                titulo: 'Manual de mantenimiento preventivo', duracionMin: 25 },
          { id: 'm2-s22-c3', tipo: 'INTERACTIVO',        titulo: 'Checklist interactivo: Pasos de mantenimiento por equipo', duracionMin: 20 },
          { id: 'm2-s22-c4', tipo: 'ACTIVIDAD_PRACTICA', titulo: 'Actividad: Diseña tu plan de mantenimiento mensual', duracionMin: 55 }] },
  ...
  // ── M3 — Zona de Almacén (20h) ──────────────────────────────────────────
  {
    ...
    sesiones: [
      ...
      { id: 'M3-S26-A', nombre: 'Consumibles',
        duracionHoras: 1.5, modalidad: 'asincrono', formato: 'Presentación + Video + Interactivo + Actividad',
        contenidos: [
          { id: 'm3-s26-c1', tipo: 'PRESENTACION',       titulo: 'Slides: Consumibles — Zona de Almacén', duracionMin: 15 },
          { id: 'm3-s26-c2', tipo: 'VIDEO',              titulo: 'Video: Tipos y uso de consumibles por herramienta', duracionMin: 20 },
          { id: 'm3-s26-c3', tipo: 'INTERACTIVO',        titulo: 'Seleccionador: ¿Qué consumible corresponde a cada herramienta de almacén?', duracionMin: 20 },
          { id: 'm3-s26-c4', tipo: 'ACTIVIDAD_PRACTICA', titulo: 'Actividad: Inventario de consumibles del taller', duracionMin: 35 }] },
      ...
      { id: 'M3-S29-A', nombre: 'Mantenimiento preventivo',
        duracionHoras: 2, modalidad: 'asincrono', formato: 'Presentación + Manuales + Interactivo + Actividad',
        contenidos: [
          { id: 'm3-s29-c1', tipo: 'PRESENTACION',       titulo: 'Slides: Mantenimiento preventivo — Zona de Almacén', duracionMin: 20 },
          { id: 'm3-s29-c2', tipo: 'PDF',                titulo: 'Manual de mantenimiento preventivo', duracionMin: 25 },
          { id: 'm3-s29-c3', tipo: 'INTERACTIVO',        titulo: 'Checklist interactivo: Rutina de mantenimiento por herramienta', duracionMin: 20 },
          { id: 'm3-s29-c4', tipo: 'ACTIVIDAD_PRACTICA', titulo: 'Actividad: Diseña tu plan de mantenimiento mensual', duracionMin: 55 }] },
  ...
  // ── M4 — Zona de Innovación (40h, Presencial) ───────────────────────────
  {
    ...
    sesiones: [
      ...
      { id: 'M4-S34-A', nombre: 'Consumibles',
        duracionHoras: 1, modalidad: 'asincrono', formato: 'Presentación + Video + Interactivo + Actividad',
        contenidos: [
          { id: 'm4-s34-c1', tipo: 'PRESENTACION',       titulo: 'Slides: Consumibles — Zona de Innovación', duracionMin: 10 },
          { id: 'm4-s34-c2', tipo: 'VIDEO',              titulo: 'Video: Consumibles y materiales para prácticas', duracionMin: 15 },
          { id: 'm4-s34-c3', tipo: 'INTERACTIVO',        titulo: 'Selector interactivo: Consumibles por equipo de innovación', duracionMin: 15 },
          { id: 'm4-s34-c4', tipo: 'ACTIVIDAD_PRACTICA', titulo: 'Actividad: Lista de consumibles para la práctica presencial', duracionMin: 20 }] },
  ...
  // ── M5 — Programa Formativo (15h) ────────────────────────────────────────
  {
    ...
    sesiones: [
      ...
      { id: 'M5-S51-A', nombre: 'Competencia 1',
        duracionHoras: 2, modalidad: 'asincrono', formato: 'Presentación + Video + Interactivo + Quiz',
        contenidos: [
          { id: 'm5-s51-c1', tipo: 'PRESENTACION', titulo: 'Slides: Competencia 1 del Programa Formativo EPT', duracionMin: 20 },
          { id: 'm5-s51-c2', tipo: 'VIDEO',         titulo: 'Video: Competencia 1 en la práctica docente', duracionMin: 50 },
          { id: 'm5-s51-c3', tipo: 'INTERACTIVO',   titulo: 'Escenario pedagógico: ¿Cómo aplicas la Competencia 1 en tu taller?', duracionMin: 20 },
          { id: 'm5-s51-c4', tipo: 'QUIZ',          titulo: 'Quiz: Competencia 1', preguntas: 8, duracionMin: 30 }] },
      ...
      { id: 'M5-S53-A', nombre: 'Competencia 2',
        duracionHoras: 2, modalidad: 'asincrono', formato: 'Presentación + Video + Interactivo + Quiz',
        contenidos: [
          { id: 'm5-s53-c1', tipo: 'PRESENTACION', titulo: 'Slides: Competencia 2 del Programa Formativo EPT', duracionMin: 20 },
          { id: 'm5-s53-c2', tipo: 'VIDEO',         titulo: 'Video: Competencia 2 en la práctica docente', duracionMin: 50 },
          { id: 'm5-s53-c3', tipo: 'INTERACTIVO',   titulo: 'Escenario pedagógico: ¿Cómo aplicas la Competencia 2 en tu taller?', duracionMin: 20 },
          { id: 'm5-s53-c4', tipo: 'QUIZ',          titulo: 'Quiz: Competencia 2', preguntas: 8, duracionMin: 30 }] },
      ...
      { id: 'M5-S55-A', nombre: 'Competencia 3',
        duracionHoras: 2, modalidad: 'asincrono', formato: 'Presentación + Video + Interactivo + Quiz',
        contenidos: [
          { id: 'm5-s55-c1', tipo: 'PRESENTACION', titulo: 'Slides: Competencia 3 del Programa Formativo EPT', duracionMin: 20 },
          { id: 'm5-s55-c2', tipo: 'VIDEO',         titulo: 'Video: Competencia 3 en la práctica docente', duracionMin: 50 },
          { id: 'm5-s55-c3', tipo: 'INTERACTIVO',   titulo: 'Escenario pedagógico: ¿Cómo aplicas la Competencia 3 en tu taller?', duracionMin: 20 },
          { id: 'm5-s55-c4', tipo: 'QUIZ',          titulo: 'Quiz: Competencia 3', preguntas: 8, duracionMin: 30 }] },
      ...
      { id: 'M5-S57-A', nombre: 'Competencia 4',
        duracionHoras: 2, modalidad: 'asincrono', formato: 'Presentación + Video + Interactivo + Quiz',
        contenidos: [
          { id: 'm5-s57-c1', tipo: 'PRESENTACION', titulo: 'Slides: Competencia 4 del Programa Formativo EPT', duracionMin: 20 },
          { id: 'm5-s57-c2', tipo: 'VIDEO',         titulo: 'Video: Competencia 4 en la práctica docente', duracionMin: 50 },
          { id: 'm5-s57-c3', tipo: 'INTERACTIVO',   titulo: 'Escenario pedagógico: ¿Cómo aplicas la Competencia 4 en tu taller?', duracionMin: 20 },
          { id: 'm5-s57-c4', tipo: 'QUIZ',          titulo: 'Quiz: Competencia 4', preguntas: 8, duracionMin: 30 }] },

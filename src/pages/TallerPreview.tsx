      ...
      <section className="relative overflow-hidden pt-14" style={{ background: '#043941', minHeight: '88vh' }}>
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 py-16 md:py-24 grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-sm leading-relaxed mb-5" style={{ color: 'rgba(255,255,255,0.6)', maxWidth: 420 }}>
              {taller.descripcion}
            </p>
                  ...
                  <li key={i} className="flex items-start gap-2.5">
                    <span className="h-4 w-4 rounded-full flex items-center justify-center shrink-0 mt-0.5"
                      ...
                      <svg width="8" height="8" viewBox="0 0 8 8" fill="none">
                        <path d="M1.5 4L3.2 5.8L6.5 2.2" stroke="#02d47e" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                    </span>
                    <span className="text-xs leading-snug" style={{ color: 'rgba(255,255,255,0.65)' }}>{c}</span>
                  </li>
                ))}
              </ul>
            </div>
